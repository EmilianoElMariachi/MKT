            ...
            using (StringWriter output = new StringWriter())
            {
                ...
                try
                {
                    try
                    {
                        ...
                        {
                            Services.WinDefendExclusion("Add", CommonUtilities.EscapePath(AutoKMSInstallPath + Path.DirectorySeparatorChar + AutoKMSFileName));
                        }
                    ...
                    catch (Exception)
                    {
                        ...
                        if (OSVersion.GetWindowsNumber() >= 6.3)
                        {
                            Services.WinDefendExclusion("Remove", CommonUtilities.EscapePath(AutoKMSInstallPath + Path.DirectorySeparatorChar + AutoKMSFileName));
                        }
