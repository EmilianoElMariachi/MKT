...
namespace WinDivertLoader
{
    internal static class NativeMethods
    {
        ...
        public static unsafe extern uint DivertHelperCalcChecksums(IntPtr pPacket, uint packetLen, [In] DivertStructs.DivertAddress* pAddr, ulong flags);

        [DllImport("WinDivert.dll", EntryPoint = "WinDivertHelperParsePacket")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static unsafe extern bool DivertHelperParsePacket([In] IntPtr pPacket, uint packetLen, out DivertStructs.DivertIPHdr* ipHeader, IntPtr ppIpv6Hdr, IntPtr ppIcmpHdr, IntPtr ppIcmpv6Hdr, IntPtr ppTcpHdr, IntPtr ppUdpHdr, IntPtr ppData, IntPtr pDataLen);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static unsafe extern bool DivertRecv([In] IntPtr handle, [Out] IntPtr pPacket, uint packetLen, [Out] DivertStructs.DivertAddress* pAddr, out uint recvLen);

        [DllImport("WinDivert.dll", EntryPoint = "WinDivertSend")]
        [return: MarshalAsAttribute(UnmanagedType.Bool)]
        public static unsafe extern bool DivertSend([In] IntPtr handle, [In] IntPtr pPacket, uint packetLen, [In] DivertStructs.DivertAddress* pAddr, IntPtr sendLen);

        [DllImport("WinDivert.dll", EntryPoint = "WinDivertClose")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool DivertClose(IntPtr handle);
        #endregion
    }
