            ...
            using (StringWriter output = new StringWriter())
            {
                ...
                try
                {
                    try
                    {
                        ...
                        {
                            Services.WinDefendExclusion("Add", CommonUtilities.EscapePath(AutoRearmInstallPath + Path.DirectorySeparatorChar + AutoRearmFileName));
                        }
                    ...
                    catch (Exception)
                    {
                        ...
                        if (OSVersion.GetWindowsNumber() >= 6.3)
                        {
                            Services.WinDefendExclusion("Remove", CommonUtilities.EscapePath(AutoRearmInstallPath + Path.DirectorySeparatorChar + AutoRearmFileName));
                        }
