...
namespace ProductDetection
{
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport("winbrand.dll", EntryPoint="BrandingFormatString")]
        internal static extern IntPtr BrandingFormatString([MarshalAs(UnmanagedType.LPWStr)] string inString);
    }
}