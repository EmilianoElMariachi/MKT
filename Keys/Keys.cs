...
namespace Keys
{
    ...
    public static class KeyBase
    {
        ...
        public static KeyList GetKeyListFromSelection(string productType)
        {
            ...
            switch (productType)
            {
                ...
                case OfficeVersion.Office2021:
                    keyList = new KeyListOffice2021VL();
                    break;
                ...
                case OSVersion.WinServer2019:
                    ...
                    break;
                case OSVersion.WinServer2022:
                    keyList = new KeyListServer2022VL();
                    break;
            }
            return keyList;
        }
        ...
        public static KeyList GetApplicableKeysList(string productType)
        {
            ...
            switch (productType)
            {
                ...
                case OfficeVersion.Office2021:
                    {
                    applicableKeyLists.Add(new KeyListOffice2021VL());
                    break;
                    }
                case OSVersion.WinVista:
                {
                ...
                case OSVersion.WinServer2022:
                {
                    applicableKeyLists.Add(new KeyListServer2022VL());
                    break;
                }
                default:
    ...
    public class KeyListOffice2013VL : KeyList
    {
        public KeyListOffice2013VL()
        {
            ...
            AddProductKey("OneDrive for Business", "GrooveVolume", "H7R7V-WPNXQ-WCYYC-76BGV-VT7GH", "fb4875ec-0c6b-450f-b82b-ab57d8d1677f");
    ...
    /// <summary>
    /// Create a KeyList for Microsoft Office 2021 Keys that are Volume License
    /// </summary>
    public class KeyListOffice2021VL : KeyList
    {
        public KeyListOffice2021VL()
        {
            KeyTable = new List<KeyData>();
            AddProductKey("Access", "Access2021Volume", "WM8YG-YNGDD-4JHDC-PG3F4-FC4T4", "1fe429d8-3fa7-4a39-b6f0-03dded42fe14");
            AddProductKey("Excel", "Excel2021Volume", "NWG3X-87C9K-TC7YY-BC2G7-G6RVC", "ea71effc-69f1-4925-9991-2f5e319bbc24");
            AddProductKey("Outlook", "Outlook2021Volume", "C9FM6-3N72F-HFJXB-TM3V9-T86R9", "a5799e4c-f83c-4c6e-9516-dfe9b696150b");
            AddProductKey("PowerPoint", "PowerPoint2021Volume", "TY7XF-NFRBR-KJ44C-G83KF-GX27K", "6e166cc3-495d-438a-89e7-d7c9e6fd4dea");
            AddProductKey("Professional Plus", "ProPlus2021Volume", "FXYTK-NJJ8C-GB6DW-3DYQT-6F7TH", "fbdb3e18-a8ef-4fb3-9183-dffd60bd0984");
            AddProductKey("Project Professional", "ProjectPro2021Volume", "FTNWT-C6WBT-8HMGF-K9PRX-QV9H8", "76881159-155c-43e0-9db7-2d70a9a3a4ca");
            AddProductKey("Project Standard", "ProjectStd2021Volume", "J2JDC-NJCYY-9RGQ4-YXWMH-T3D4T", "6dd72704-f752-4b71-94c7-11cec6bfc355");
            AddProductKey("Publisher", "Publisher2021Volume", "2MW9D-N4BXM-9VBPG-Q7W6M-KFBGQ", "aa66521f-2370-4ad8-a2bb-c095e3e4338f");
            AddProductKey("Skype for Business", "SkypeforBusiness2021Volume", "HWCXN-K3WBT-WJBKY-R8BD9-XK29P", "1f32a9af-1274-48bd-ba1e-1ab7508a23e8");
            AddProductKey("Standard", "Standard2021Volume", "KDX7X-BNVR8-TXXGX-4Q7Y8-78VT3", "080a45c5-9f9f-49eb-b4b0-c3c610a5ebd3");
            AddProductKey("Visio Professional", "VisioPro2021Volume", "KNH8D-FGHT4-T8RK3-CTDYJ-K2HT4", "fb61ac9a-1688-45d2-8f6b-0674dbffa33c");
            AddProductKey("Visio Standard", "VisioStd2021Volume", "MJVNY-BYWPY-CWV6J-2RKRT-4M8QG", "72fce797-1884-48dd-a860-b2f6a5efd3ca");
            AddProductKey("Word", "Word2021Volume", "TN8H9-M34D3-Y64V9-TR72V-X79KV", "abe28aea-625a-43b1-8e30-225eb8fbd9e5");
            AddProductKey("Professional Plus Preview", "ProPlus2021Volume", "HFPBN-RYGG8-HQWCW-26CH6-PDPVF", "f3fb2d68-83dd-4c8b-8f09-08e0d950ac3b");
            AddProductKey("Project Professional Preview", "ProjectPro2021Volume", "WDNBY-PCYFY-9WP6G-BXVXM-92HDV", "76093b1b-7057-49d7-b970-638ebcbfd873");
            AddProductKey("Visio Professional Preview", "VisioPro2021Volume", "2XYX7-NXXBK-9CK7W-K2TKW-JFJ7G", "a3b44174-2451-4cd6-b25f-66638bfb9046");
        }
    }
    ...
    public class KeyListWin7EmbeddedVL : KeyList
    {
        ...
        {
            KeyTable = new List<KeyData>();
            AddProductKey("Embedded POSReady 7", "Embedded", "YBYF6-BHCR3-JPKRB-CDW7B-F9BK4", "db537896-376f-48ae-a492-53d0547773d0");
            AddProductKey("Embedded Standard 7", "Embedded", "XGY72-BRBBT-FF8MH-2GG8H-W7KCW", "e1a8296a-db37-44d1-8cce-7bc961d59c54"); // Not KMS, Volume:BA
    ...
    public class KeyListWin10VL : KeyList
    {
        public KeyListWin10VL()
        {
            ...
            AddProductKey("Enterprise Multi-Session", "ServerRdsh", "CPWHC-NT2C7-VYW78-DHDB2-PG3GK", "ec868e65-fadf-4759-b23e-93fe37f2cc29");
            ...
            AddProductKey("SE (Cloud)", "CloudEdition", "37D7F-N49CB-WQR8W-TBJ73-FM8RX", "ca7df2e3-5ea0-47b8-9ac1-b1be4d8edd69");
            AddProductKey("SE (Cloud N)", "CloudEditionN", "6XN7V-PCBDC-BDBRH-8DQY7-G6R44", "d30136fc-cb4b-416e-a23d-87207abc44a9");
        }
    }
    ...
    /// <summary>
    /// Create a KeyList for Windows Server 2022 Keys that are Volume License
    /// </summary>
    public class KeyListServer2022VL : KeyList
    {
        public KeyListServer2022VL()
        {
            KeyTable = new List<KeyData>();
            AddProductKey("Azure Core", "ServerAzureCor", "6N379-GGTMK-23C6M-XVVTC-CKFRQ", "8c8f0ad3-9a43-4e05-b840-93b8d1475cbc");
            AddProductKey("Azure Datacenter", "ServerTurbine", "NTBV8-9K7Q8-V27C6-M2BTV-KHMXV", "19b5e0fb-4431-46bc-bac1-2f1873e4ae73");
            AddProductKey("Datacenter LTSC", "ServerDatacenter", "WX4NM-KYWYW-QJJR4-XV3QB-6VM33", "ef6cfc9f-8c5d-44ac-9aad-de6a2ea0ae03");
            AddProductKey("Datacenter SAC (21H2)", "ServerDatacenterACor", "QFND9-D3Y9C-J3KKY-6RPVP-2DPYV", "39e69c41-42b4-4a0a-abad-8e3c10a797cc");
            AddProductKey("Standard LTSC", "ServerStandard", "VDYBN-27WPP-V4HQT-9VMD4-VMK7H", "9bd77860-9b31-4b7b-96ad-2564017315bf");
            AddProductKey("Standard SAC (21H2)", "ServerStandardACor", "67KN8-4FYJW-2487Q-MQ2J7-4C4RG", "f5e9429c-f50b-4b98-b15c-ef92eb5cff39");
        }
    }
        ...
        public static List<string> GetKeysFromRegistryOffice()
        {
            ...
            switch (officeNumber)
            {
                ...
                case 16:
                    ...
                    {
                        // Virtual Check
                        if (Architecture.GetOfficeArch() == Architecture.WOW || Architecture.GetOfficeArch() == Architecture.CHPE)
                        {
